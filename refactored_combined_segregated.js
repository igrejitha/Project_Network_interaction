...
document.querySelector("[onclick="closeModal('riskMatrixModal')"]").click = function() { closeModal('riskMatrixModal') };
document.querySelector("[onclick="rotate(-10)"]").click = function() { rotate(-10) };
document.querySelector("[onclick="closeModal('SCurveModal')"]").click = function() { closeModal('SCurveModal') };
document.querySelector("[onclick="openModal('riskMatrixModal')"]").click = function() { openModal('riskMatrixModal') };
document.querySelector("[onclick="openModal('pieChartModal')"]").click = function() { openModal('pieChartModal') };
document.querySelector("[onclick="openModal('radialChartModal')"]").click = function() { openModal('radialChartModal') };
document.querySelector("[onclick="toggleSidebar(event)"]").click = function() { toggleSidebar(event) };
document.querySelector("[onclick="closeModal('pieChartModal')"]").click = function() { closeModal('pieChartModal') };
document.querySelector("[onclick="center()"]").click = function() { center() };
document.querySelector("[onclick="rotate(10)"]").click = function() { rotate(10) };
document.querySelector("[onclick="zoomExtents()"]").click = function() { zoomExtents() };
document.querySelector("[onclick="closeModal('histogramModal')"]").click = function() { closeModal('histogramModal') };
document.querySelector("[onclick="openModal('pathDistributionModal')"]").click = function() { openModal('pathDistributionModal') };
document.querySelector("[onclick="pan(0, -50)"]").click = function() { pan(0, -50) };
document.querySelector("[onclick="openModal('SCurveModal')"]").click = function() { openModal('SCurveModal') };
document.querySelector("[onclick="closeModal('modal0')"]").click = function() { closeModal('modal0') };
document.querySelector("[onclick="zoomIn()"]").click = function() { zoomIn() };
document.querySelector("[onclick="closeModal('pathDistributionModal')"]").click = function() { closeModal('pathDistributionModal') };
document.querySelector("[onclick="closeModal('ganttChartModal')"]").click = function() { closeModal('ganttChartModal') };
document.querySelector("[onclick="openModal('modal0')"]").click = function() { openModal('modal0') };
document.querySelector("[onclick="pan(0, 50)"]").click = function() { pan(0, 50) };
document.querySelector("[onclick="zoomOut()"]").click = function() { zoomOut() };
document.querySelector("[onclick="pan(50, 0)"]").click = function() { pan(50, 0) };
document.querySelector("[onclick="openModal('histogramModal')"]").click = function() { openModal('histogramModal') };
document.querySelector("[onclick="openModal('pathsDistributionCurveModal')"]").click = function() { openModal('pathsDistributionCurveModal') };
document.querySelector("[onclick="closeModal('radialChartModal')"]").click = function() { closeModal('radialChartModal') };
document.querySelector("[onclick="closeModal('networkVisualizationModal')"]").click = function() { closeModal('networkVisualizationModal') };
document.querySelector("[onclick="pan(-50, 0)"]").click = function() { pan(-50, 0) };
document.querySelector("[onclick="closeModal('reducedGraphModal')"]").click = function() { closeModal('reducedGraphModal') };
document.querySelector("[onclick="closeModal('pathsDistributionCurveModal')"]").click = function() { closeModal('pathsDistributionCurveModal') };